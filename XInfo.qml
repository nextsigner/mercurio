...
Rectangle {
    ...
    Component.onCompleted: {
        txtInfo.text='Unik Qml Engine y Mercurio son aplicaciones desarrolladas con el frameworik Qt Open Source por @nextsigner y su equipo de colaboradores.<br />Para más información sobre el Qt Project diríjase a <a href="www.qt.io/">www.qt.io/</a><br /><br />'
